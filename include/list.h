 ...
 * @param free_function if non-NULL, a function to call on elements in the list
 ...
 * @return a deep copy of the given list (i.e. a new pointer to an
 * identical-looking list at a different address)
 */
