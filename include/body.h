...
/**
 * Initializes a body that has a particular texture and a rectangular
 * bounding box.
 *
 * @param mass the mass of the body
 * @param body_type the type of the body
 * @param texture_path the absolute path of the PNG texture
 * @param width the width the sprite should be
 * @param height the height the sprite should be
 *
 * @return the body representing the sprite
 */
...
/**
 * Gets the elasticity of a body.
 *
 * @param body a pointer to a body returned from body_init()
 * @return the body's elasticity.
 */
double body_get_elasticity(body_t *body);

/**
 * Gets the current absolute angle of a body.
 *
 * @param body a pointer to a body returned from body_init()
 * @return the body's absolute angle.
 */
 ...
 *
 * @param body a pointer to a body returned from body_init()
 * @return the body's texture (or NULL if it is a polygon).
 */
 ...
 */
double body_get_angvel(body_t *body);

/**
 * Gets the number of vertices in the body.
 *
 * @param body a pointer to a body returned from body_init()
 * @return the number of vertices in the body.
 */
int body_get_size(body_t *body);
 ...
 *
 * @param body a pointer to a body returned from body_init()
 * @param angvel the body's new angular velocity.
 */
void body_set_angvel(body_t *body, double angvel);
...
void body_set_flipped(body_t *body, bool flipped);
